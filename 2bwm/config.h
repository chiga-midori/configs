...
static const uint8_t offsets[] = {0,0,0,18};
///---Colors---///
/*0)focuscol         1)unfocuscol
 *2)fixedcol         3)unkilcol
 *4)fixedunkilcol    5)outerbordercol
 *6)emptycol         */
// static const char *colors[] = {"#080703","#c4c4a3","#e4e4c3","#a4a483","#cc9933","#0d131a","#000000"};
// static const char *colors[] = {"#35586c","#333333","#7a8c5c","#ff6666","#cc9933","#0d131a","#000000"};
// static const char *colors[] = {"#35586c","#333333","#7a8c5c","#6666ff","#cc9933","#0d131a","#000000"};
// static const char *colors[] = {"#ebdbb2","#282828","#fb4934","#d3869b","#458588","#ebdbb2","#000000"};
static const char *colors[] = {"#efc191","#282828","#fb4934","#d3869b","#458588","#686868","#000000"};
...
///--Menus and Programs---///
// static const char *menucmd[]   = { "rofi", "-no-config", "-no-lazy-grab", "-show", "drun", "-modi", "drun", "-font", "DinaRemasterII 12", "-theme", "/usr/share/rofi/themes/nier.rasi", NULL };
static const char *menucmd[]   = { "rofi", "-no-config", "-no-lazy-grab", "-show", "drun", "-modi", "drun", "-font", "DinaRemasterII 12", "-theme", "/home/aarl/.config/rofi/config.rasi", NULL };
// static const char *terminalcmd[] = { "urxvt", "-ls", NULL };
static const char *terminalcmd[] = { "xterm", "-ti", "vt340", NULL };
static const char *screenshotcmd[] = { "scsh.sh", NULL };
static const char *volumetoggle[] = {"amixer", "-q", "sset", "Master,0", "toggle", NULL};
static const char *volumeup[] = {"amixer", "set", "Master", "5%+", "unmute", NULL};
static const char *volumedown[] = {"amixer", "set", "Master", "5%-", "unmute", NULL};
static const char *gotosleep[] = {"doas", "pm-suspend", NULL};
static const char *helpme[] = {"xterm", "-e", "less", "/usr/share/2bwm/.2bhelp"};
///--Custom foo---///
...
static key keys[] = {
    ...
    {  0 ,                XF86XK_AudioRaiseVolume, start,   {.com = volumeup}},
    {  0 ,                XF86XK_AudioLowerVolume, start,   {.com = volumedown}},
    // Sleep
    {  0 ,                XF86XK_Sleep,  start,             {.com = gotosleep}},
    // Help
    {  MOD ,		 XK_Help,	start,		   {.com = helpme}},
